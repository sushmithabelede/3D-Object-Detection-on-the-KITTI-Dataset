...
network = FrustumPointNet("Frustum-PointNet_eval_val", project_dir="/home/bebop_member/Downloads/DL_3DOD/3DOD_thesis")
network.load_state_dict(torch.load("/home/bebop_member/Downloads/DL_3DOD/3DOD_thesis/training_logs/model_Frustum-PointNet_1_morefcns/checkpoints/model_Frustum-PointNet_1_morefcns_epoch_199.pth"))
...
with open("%s/eval_dict_val_morefcns.pkl" % network.model_dir, "wb") as file:
    pickle.dump(eval_dict, file, protocol=2) # (protocol=2 isx-special/nautilus-clipboard
copy
